...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHJ1b25nbmdvIiwiYSI6ImNrdzNtemM0MzhtaWwybnMxcjFrdDlvYnIifQ.yLOYopnELPaTMFtzL0b4xQ';
  ...
  regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51JyYdyEmBjqazhDY2COLIwDaTKhpUVQmPYe2riMi1IPpxJI6ibxIod2oQdX54d1Q6qgPrw9aHb1xPEEyWsDpRJTO00LrzYnmxt');
            _context.prev = 1;
            _context.next = 4;
...
if (userPasswordFrom) userPasswordFrom.addEventListener('submit',
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
