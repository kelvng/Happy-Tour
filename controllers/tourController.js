...
const sharp = require('sharp'); // processing img
const APIFeatures = require('./../utils/apiFeatures');
const catchAsync = require('./../utils/catchAsync');
const AppError = require('./../utils/appError');
const factory = require('./handlerFactory');

// save img to memory instead of disk
const multerStorage = multer.memoryStorage();

// check the upload file is an image ?
...
exports.aliasTopTours = (req, res, next) => {
  ...
  req.query.fields = 'name,price,ratingsAverage,summary,season';
  next();
};
  ...
  const distances = await Tour.aggregate([
    {
      ...
      $geoNear: {
        ...
        // where all the calculated distances stored
